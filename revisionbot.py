...
Original file is located at
    https://colab.research.google.com/drive/1Yw6i0RsfjCqBk-BphIIS4cm4bsWw4qEq

# **Installation des dépendances**
"""

# 1. INSTALLATION
#!pip install python-telegram-bot==20.7 nest_asyncio --quiet
...
TOKEN = "7684143978:AAHcHGL4eKNsiwn66R-ZCdYL5E_YaDhNfU8"  # 🔐 Remplace ce texte par ton vrai token
...
async def verifier_reponse(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Supprimer les boutons tout en gardant la question visible
    await query.edit_message_reply_markup(reply_markup=None)

    # Construire le message de correction dans le style demandé
